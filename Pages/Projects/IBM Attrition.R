...
plot(ROC.boost$specificities,ROC.boost$sensitivities, xlim=rev(range(ROC.boost$sensitivities)), type='l', xlab="Specificity", ylab="Sensitivity")
lines(ROC.rf$specificities,ROC.rf$sensitivities, xlim=rev(range(ROC.rf$sensitivities)), type='l', col='red')
lines(ROC.lasso$specificities,ROC.lasso$sensitivities, xlim=rev(range(ROC.lasso$sensitivities)), type='l', col='blue')
